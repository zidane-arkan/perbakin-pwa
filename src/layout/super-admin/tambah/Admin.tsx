    ...
    return (
        <Layout className={'rounded-3xl mt-20 mb-[5%]'}>
            ...
            <LayoutChild className='flex-col'>
                <section className='flex flex-row max-w-full w-full text-center text-[#036BB0]'>
                    <button className='w-[24px] h-[24px] mt-1' type='button' onClick={() => navigate(-1)}>
                ...
                <form onSubmit={createAdminHandler} className='flex flex-col w-full h-auto justify-between gap-8 pt-14'>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <button type="submit" className="text-white rounded-lg text-base font-bold w-full sm:w-auto px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">Register</button>
                    </div>
                </form>
            </LayoutChild>
        </Layout>
