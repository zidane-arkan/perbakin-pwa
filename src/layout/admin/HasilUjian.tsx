            ...
            <LayoutChild className='flex-col gap-0 h-auto'>
                <form className='flex flex-col w-full h-auto justify-between'>
                    <div className="relative">
                        ...
                        <input type="text" className="w-full py-3 pl-10 pr-4 text-gray-700 bg-white border rounded-full focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40" placeholder="Cari" />
                    </div>
                </form>
                <TabelHasilUjian />
                <section></section>
