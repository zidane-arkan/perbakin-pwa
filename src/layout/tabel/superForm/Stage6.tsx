...
const Stage6 = () => {
    ...
    const finishPercobaan1 = async () => {
        ...
        if (confirmed) {
            const endpoint = `/super/exam/${examid}/scorer/${scorerid}/shooter/${shooterid}/result/stage6/2`;
            setIsLoading(true);
            try {
    ...
    return (
        <section className="flex flex-col gap-8">
            ...
            <form onSubmit={handleUpdateValues}>
                ...
                >
                    {isSaving ? 'Menyimpan...' : 'Simpan Stage 6'}
                </button>
            </form>
        </section>
    );
