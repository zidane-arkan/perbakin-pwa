        ...
        <Layout className={'rounded-3xl mt-20 mb-[5%]'}>
            <LayoutChild className='flex-col'>
                <div className='max-w-full text-center text-[#036BB0]'>
                    <h1 className='pb-2 text-4xl font-extrabold'>Registrasi</h1>
                    <h4 className='text-base text-[#6A7682] font-normal'>Silahkan melakukan  registrasi sebagai Super Admin untuk dapat membuat ujian baru.</h4>
                </div>
